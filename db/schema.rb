...
ActiveRecord::Schema.define(:version => 20131127170535931) do
  ...
  add_index "attendances", ["attended_event_id", "attendee_id"], :name => "index_attendances_on_attended_event_id_and_attendee_id", :unique => true
